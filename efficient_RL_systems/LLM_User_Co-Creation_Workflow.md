...
## **RL-Specific Prompting Template**

### For RL Framework Papers:
```
"Analyze this RL paper focusing on:
- Hardware optimizations (GPU/CPU/Network)
- Training phases (Inference/Training/Buffer)
- Scenario applications (Math/Coding/Alignment/Multi-agents)
- Performance metrics and speedup factors
- Extract figures showing architecture and results
- Add external links to relevant technologies"
```

### For RL System Frameworks:
```
"Document this RL framework with:
- System runtime architecture
- Integration patterns with existing tools
- Hardware requirements and optimizations
- Use cases and application scenarios
- Link to official docs and GitHub repository"
```
